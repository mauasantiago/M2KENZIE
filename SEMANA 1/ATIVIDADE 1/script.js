...
*/
const recipiente = document.querySelector(".recipe");
console.log(recipiente);
/*
  Desafio 1: Selecione todos os elementos <h2> da página e altere a cor do texto de
   todos para azul.
*/
const allBlue = document.getElementsByTagName("h2");
for(let i=0; i < allBlue.length; i++){
    allBlue[i].style.backgroundColor = "blue"
};
...
/* 
  Desafio 2: Selecione todos os elementos <input> da página, e altere a cor da borda de
   todos para vermelho.
*/
const borderRed = document.querySelectorAll("input");
for (let r = 0; r < borderRed.length; r++){
    borderRed[r].style.border = "2px solid red"
}